...
summary: BlueXPのデジタルウォレットでは、NetApp（BYOL）から直接購入したライセンスを管理して、BlueXPのバックアップとリカバリ、分類、ディザスタリカバリ、階層化に使用できます。使用済みライセンス容量、残りの空き容量を確認でき、容量の上限や有効期限に達した場合に通知が表示されます。 
---
...
[role="lead"]
BlueXPのデジタルウォレットでは、NetApp（BYOL）から直接購入したライセンスを管理して、BlueXPのバックアップとリカバリ、分類、ディザスタリカバリ、階層化に使用できます。使用済みライセンス容量、残りの空き容量を確認でき、容量の上限や有効期限に達した場合に通知が表示されます。
